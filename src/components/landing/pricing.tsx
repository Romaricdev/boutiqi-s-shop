...
const plans: {
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Futur : abonnement prélevé via Orange Money & MTN MoMo", available: true },
      { text: "Gestion de stock automatique", available: true },
      { text: "Statistiques de ventes avancées", available: true },
      { text: "Pas de commission Boutiki sur les ventes (paiements hors plateforme pour l’instant)", available: true },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Même règle : pas de commission sur les ventes tant que l’encaissement n’est pas sur Boutiki", available: true },
    ],
    cta: "Bientôt disponible",
  },
];
